...
//Tools
const ruToolMap = {
	"инструменты алхимика": "alchemist",
	"инструменты пивовара": "brewer",
	"инструменты каллиграфа": "calligrapher",
	"инструменты плотника": "carpenter",
	"инструменты картографа": "cartographer",
	"инструменты сапожника": "cobbler",
	"инструменты повара": "cook",
	"инструменты стеклодува": "glassblower",
	"инструменты ювелира": "jeweler",
	"инструменты кожевника": "leatherworker",
	"инструменты каменщика": "mason",
	"инструменты художника": "painter",
	"инструменты гончара": "potter",
	"инструменты кузнеца": "smith",
	"инструменты механика": "tinker",
	"инструменты ткача": "weaver",
	"инструменты резчика": "woodcarver",
	"маскировочный набор": "disg",
	"набор для подделки": "forg",
	"набор для игры в кости": "dice",
	кости: "dice",
	"набор драконьих шахмат": "chess",
	"драконьи шахматы": "chess",
	"набор игральных карт": "card",
	"игральные карты": "card",
	"набор травника": "herb",
	волынка: "bagpipes",
	барабан: "drum",
	цимбалы: "dulcimer",
	...
	шалмей: "shawm",
	виола: "viol",
	"инструменты навигатора": "navg",
	"набор отравителя": "pois",
	"инструменты вора": "thief",
	"транспорт (воздушный)": "air",
	"воздушный транспорт": "air",
	"транспорт (наземный)": "land",
	"наземный транспорт": "land",
	"транспорт (космический)": "space",
	"космический транспорт": "space",
	"транспорт (водный)": "water",
	"водный транспорт": "water",
};

//Damage Types
const ruDamageTypeMap = {
	кислота: "acid",
	кислотой: "acid",
	дробящий: "bludgeoning",
	дробящего: "bludgeoning",
	холод: "cold",
	холодом: "cold",
	огонь: "fire",
	огнём: "fire",
	...
	некротического: "necrotic",
	колющий: "piercing",
	колющего: "piercing",
	яд: "poison",
	ядом: "poison",
	психический: "psychic",
	психического: "psychic",
	лучистый: "radiant",
	лучистого: "radiant",
	режущий: "slashing",
	режущего: "slashing",
...
const ruConditionMap = {
    ...
    ослеплено: "blinded",
	обворожение: "charmed",
	обворожённый: "charmed",
	обворожённая: "charmed",
	...
	оглохшая: "deafened",
	оглохшее: "deafened",
	утомпление: "exhaustion",
	утомления: "exhaustion",
	испуг: "frightened",
	испуга: "frightened",
	испуганный: "frightened",
	испуганная: "frightened",
	...
	схваченная: "grappled",
	схваченное: "grappled",
	захваченный: "grappled",
	захваченная: "grappled",
	захваченное: "grappled",
	"выход из строя": "incapacitated",
	"выведен из строя": "incapacitated",
	"выведена из строя": "incapacitated",
	"выведено из строя": "incapacitated",
	"выведенный из строя": "incapacitated",
	"выведенная из строя": "incapacitated",
	"выведенное из строя": "incapacitated",
	...
	парализована: "paralyzed",
	парализовано: "paralyzed",
	парализованный: "paralyzed",
	парализованная: "paralyzed",
	парализованное: "paralyzed",
	отравление: "poisoned",
	отравлен: "poisoned",
	отравлена: "poisoned",
	отравлено: "poisoned",
	...
	распластанная: "prone",
	распластанное: "prone",
	обездвиживание: "restrained",
	обездвижен: "restrained",
	обездвижена: "restrained",
	обездвижено: "restrained",
	обездвиженный: "restrained",
	обездвиженная: "restrained",
	обездвиженное: "restrained",
	шок: "stunned",
	"в шоке": "stunned",
	"без сознания": "unconscious",
	"теряет сознание": "unconscious",
	окаменение: "petrified",
	окаменевший: "petrified",
	окаменевшая: "petrified",
	окаменевшее: "petrified", 
};
...
const ruRuleMap = {
	...
	// encumbrance: "encumbrance",
	засада: "hiding",
	"пассивное внимание": "passiveperception",
	время: "time",
	скорость: "speed",
	"темп путешествия": "travelpace",
	"марш-бросок": "forcedmarch",
	// "difficult terrain pace": "difficultterrainpace",
	лазание: "climbing",
	плаванье: "swimming",
	"прыжок в длину": "longjump",
	"прыжок в высоту": "highjump",
	прыжок: "jumping",
	падение: "falling",
	удушье: "suffocating",
	зрение: "vision",
	освещение: "light",
	"слегка затрунена": "lightlyobscured",
	"слегка затрунённая": "lightlyobscured",
	"слегка затрунённой": "lightlyobscured",
	"крайне затрудненная": "heavilyobscured",
	"крайне затрудненной": "heavilyobscured",
	"яркий свет": "brightlight",
	"тусклый свет": "dimlight",
	темнота: "darkness",
	...
	вода: "water",
	отдых: "resting",
	"короткий отдых": "shortrest",
	"длинный отдых": "longrest",
	"врасплох": "surprise",
	инициатива: "initiative",
	"бонусное действие": "bonusaction",
	"ответное действие": "reaction",
	"пересечённая местность": "difficultterrain",
	"пересечённой местностью": "difficultterrain",
	"пересечённой местности": "difficultterrain",
	// "being prone": "beingprone",
	// "dropping prone": "droppingprone",
	// "standing up": "standingup",
	ползание: "crawling",
	...
	// squeezing: "squeezing",
	атака: "attack",
	"сотворение заклинания": "castaspell",
	рывок: "dash",
	...
	подготовка: "ready",
	поиск: "search",
	"использование предмета": "useanobject",
	"броски атаки": "attackrolls",
	"невидимые атакующие": "unseenattackers",
	"невидимые цели": "unseentargets",
	"дистанционные атаки": "rangedattacks",
	дистанция: "range",
	"дистанционные атаки в ближнем бою": "rangedattacksinclosecombat",
	"атаки в ближнем бою": "meleeattacks",
	досягаемость: "reach",
	"безоружный удар": "unarmedstrike",
	"внеочередные атаки": "opportunityattacks",
	"сражение двумя оружиями": "twoweaponfighting",
	"освобождение из захвата": "escapingagrapple",
	"перемещение захваченного существа": "movingagrappledcreature",
	повалить: "shoving",
	укрытие: "cover",
	"укрытие наполовину": "halfcover",
	"укрытие на три четверти": "threequarterscover",
	"полное укрытие": "totalcover",
	"пункты здоровья": "hitpoints",
	"броски урона": "damagerolls",
	"критические удары": "criticalhits",
	"типы урона": "damagetypes",
	"устойчивости к урону": "damageresistance",
	устойчивость: "resistance",
	"уязвимость к урону": "damagevulnerability",
	уязвимость: "damagevulnerability",
	исцеления: "healing",
	"мгновенная смерть": "instantdeath",
	"испытания против смерти": "deathsavingthrows",
	// "death saves": "deathsaves",
	стабилизация: "stabilizing",
	"нокаутирование": "knockingacreatureout",
	"временные пункты здоровья": "temporaryhitpoints",
	"временные пз": "temphp",
	// mounting: "mounting",
	// dismounting: "dismounting",
	// "controlling a mount": "controllingamount",
	"подводный бой": "underwatercombat",
	"круг заклинания": "spelllevel",
	"известные заклинания": "knownspells",
	"подготовленные заклинания": "preparedspells",
	"ячейки заклинаний": "spellslots",
	// "casting at a higher level": "castingatahigherlevel",
	// upcasting: "upcasting",
	// "casting in armor": "castinginarmor",
	фокусы: "cantrips",
	ритуалы: "rituals",
	"время сотворения": "castingtime",
	// "bonus action casting": "bonusactioncasting",
	// "reaction casting": "reactioncasting",
	// "longer casting times": "longercastingtimes",
	// "spell range": "spellrange",
	...
	"длительность заклинания": "spellduration",
	мгновенное: "instantaneous",
	// concentrating: "concentrating",
	концентрация: "concentrating",
	"цель заклинания": "spelltargets",
	// "area of effect": "areaofeffect",
	// aoe: "areaofeffect",
	// "point of origin": "pointoforigin",
	"испытания против заклинаний": "spellsavingthrows",
	"броски атак заклинаниями": "spellattackrolls",
	"combining magical effects": "combiningmagicaleffects",
	"школы магии": "schoolsofmagic",
	"обнаружение ловушек": "detectingtraps",
	"обезвреживание ловушек": "disablingtraps",
	// "curing madness": "curingmadness",
	"предел прочности": "damagethreshold",
	// "poison types": "poisontypes",
	// "contact poison": "contactpoison",
	// "ingested poison": "ingestedpoison",
	// "inhaled poison": "inhaledpoison",
	// "injury poison": "injurypoison",
	настройнность: "attunement",
	"ношение предметов": "wearingitems",
	"держание предметов": "wieldingitems",
	// "multiple items of the same kind": "multipleitemsofthesamekind",
	// "paired items": "paireditems",
	"командное слово": "commandword",
	"расходуемые предметы": "consumables",
	// "item spells": "itemspells",
	заряды: "charges",
	"свиток заклинания": "spellscroll",
	// "creature tags": "creaturetags",
	телепатия: "telepathy",
	...
	помеха: "disadvantage",
	помеху: "disadvantage",
	помехой: "disadvantage",
	// "difficulty class": "difficultyclass",
	сл: "difficultyclass",
	"класс брони": "armorclass",
	кб: "armorclass",
	"проверка характеристики": "abilitycheck",
	испытание: "savingthrow",
	...
	безразличен: "indifferent",
	безразлична: "indifferent",
    безразлично: "indifferent",
	враждебный: "hostile",
	враждебна: "hostile",
	враждебно: "hostile",
	"разрушение объектов": "breakingobjects",
	угрозы: "hazards",
	окровавленность: "bloodied",
	окровавленный: "bloodied",
	окровавленная: "bloodied",
	окровавлено: "bloodied",
	окровавлен: "bloodied",
	окровавлена: "bloodied"
};

//Weapon Masteries
const ruWeaponMasteryMap = {
	// cleave: "cleave",
	// graze: "graze",
	// nick: "nick",
	// push: "push",
...
const ruAbilityList = buildAlternationGroup(ruAbilityMap);
const ruSkillList = buildAlternationGroup(ruSkillMap);
const ruToolList = buildAlternationGroup(ruToolMap);
const ruDamageTypeList = buildAlternationGroup(ruDamageTypeMap);
const ruConditionList = buildAlternationGroup(ruConditionMap);
const ruRuleList = buildAlternationGroup(ruRuleMap);
const ruWeaponMasteryList = buildAlternationGroup(ruWeaponMasteryMap);
const ruAreaTargetTypeList = buildAlternationGroup(ruAreaTargetTypeMap);
const ruSpellPropertyList = buildAlternationGroup(ruSpellPropertyMap);
const ruCreatureTypeList = buildAlternationGroup(ruCreatureTypeMap);
